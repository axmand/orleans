...
namespace Engine.Brain.Utils
{
    ...
    public partial class NP
    {
        ...
        public static class Support
        {
            ...
            /// <param name="filename">存储全路径</param>
            public static void Save(INeuralNet network, string filename)
            {
                //get model bytes
            ...
            /// <summary>
            /// 保存模型，重载强化学习模型存储 (Deep Q Network)
            /// </summary>
            /// <param name="network"></param>
            /// <param name="filename">存储全路径</param>
            public static void Save(IDeepQNet network, string filename)
            {
                //check dir
