...
namespace Engine.Brain.Utils
{
    public partial class NP
    {
        ...
        public static int PhysicalCoreCount
        {
            ...
            {
                if (coreCount == 0)
                    using (System.Management.ManagementObjectCollection collection = new System.Management.ManagementObjectSearcher("Select * from Win32_Processor").Get())
                        foreach (System.Management.ManagementBaseObject item in collection)
