using GrainImplement.DRL.Extend;
...
namespace GrainImplement.DRL.Method.ReinforcementLearning
{
    ...
    /// 学习溢油情景树
    /// </summary>
    public class DQN : IReinforcementLearning
    {
        /// <summary>
        /// reporter
        /// </summary>
            ...
            int[] actionKeys)
        {
            ...
            _criticNet = critic;
            //统一学习批次
            _batchSize = (int)actor.BatchSize;
        }
            ...
            string deviceName)
        {
            ...
            //if (innerTypeName == typeof(FCN7).Name)
            //{
            //    actor = FCN7.Load(actorBuffer, deviceName);
            //    critic = FCN7.Load(criticBuffer, deviceName);
            //}
            return new DQN(actor, critic, actionsNum, featuresNum, actionKeys);
        }
